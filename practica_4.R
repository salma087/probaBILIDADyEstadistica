...
# 1.- Creación de un vector de color
color=c("lavender", "lightblue1", "greenyellow")

# 2.- Creación del gráfico
GB1<-ggplot(penguins, aes(x=año))+
  geom_bar(colour= "darkorange", fill=color)+
...
HG<-ggplot(penguins, aes(x=largo_aleta_mm))+
  geom_histogram(col="greenyellow", fill="deeppink3")+
  ggtitle("Histograma")+
...
GD<-ggplot(penguins, aes(x=largo_pico_mm, y=grosor_pico_mm))+
  ...
  scale_color_manual(values=c("lavender","greenyellow","hotpink3"))+
